...
7750 IF N6 < 2 THEN N6=0: GOTO 7780 !- 1 Automat verbleibt auf jeden Fall, danach kommen Prostituierte dran
7760 AU(CO) = AU(CO)-N6:GOTO 7900
7780 IF PR(CO) = 0 THEN 8000
7790 N7 = INT(RND(1)*PR(CO)/2)
7800 IF N7 < 2 THEN 7890            !- 1 Prostituerte verbleibt immer
